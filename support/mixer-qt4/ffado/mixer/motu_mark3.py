...
class Motu_Mark3(QWidget):
    ...
    def init(self):
        ...
        # TODO: Find a more succint way to declare mixer variables
        ...
        self.ChannelFaders={
            ...
            self.mix5ana1_fader: ['/Mixer/fader', 4, 0, self.mix5ana2_fader],
            self.mix5ana2_fader: ['/Mixer/fader', 4, 1, self.mix5ana1_fader],
            self.mix5ana3_fader: ['/Mixer/fader', 4, 2, self.mix5ana4_fader],
            self.mix5ana4_fader: ['/Mixer/fader', 4, 3, self.mix5ana3_fader],
            self.mix5ana5_fader: ['/Mixer/fader', 4, 4, self.mix5ana6_fader],
            self.mix5ana6_fader: ['/Mixer/fader', 4, 5, self.mix5ana5_fader],
            self.mix5ana7_fader: ['/Mixer/fader', 4, 6, self.mix5ana8_fader],
            self.mix5ana8_fader: ['/Mixer/fader', 4, 7, self.mix5ana7_fader],
            self.mix5aes1_fader: ['/Mixer/fader', 4, 8, self.mix5aes2_fader],
            self.mix5aes2_fader: ['/Mixer/fader', 4, 9, self.mix5aes1_fader],
            self.mix5spdif1_fader: ['/Mixer/fader', 4, 10, self.mix5spdif2_fader],
            self.mix5spdif2_fader: ['/Mixer/fader', 4, 11, self.mix5spdif1_fader],
            self.mix5adat1_fader: ['/Mixer/fader', 4, 12, self.mix5adat2_fader],
            self.mix5adat2_fader: ['/Mixer/fader', 4, 13, self.mix5adat1_fader],
            self.mix5adat3_fader: ['/Mixer/fader', 4, 14, self.mix5adat4_fader],
            self.mix5adat4_fader: ['/Mixer/fader', 4, 15, self.mix5adat3_fader],
            self.mix5adat5_fader: ['/Mixer/fader', 4, 16, self.mix5adat6_fader],
            self.mix5adat6_fader: ['/Mixer/fader', 4, 17, self.mix5adat5_fader],
            self.mix5adat7_fader: ['/Mixer/fader', 4, 18, self.mix5adat8_fader],
            self.mix5adat8_fader: ['/Mixer/fader', 4, 19, self.mix5adat7_fader],
            
            self.mix6ana1_fader: ['/Mixer/fader', 5, 0, self.mix6ana2_fader],
            self.mix6ana2_fader: ['/Mixer/fader', 5, 1, self.mix6ana1_fader],
            self.mix6ana3_fader: ['/Mixer/fader', 5, 2, self.mix6ana4_fader],
            self.mix6ana4_fader: ['/Mixer/fader', 5, 3, self.mix6ana3_fader],
            self.mix6ana5_fader: ['/Mixer/fader', 5, 4, self.mix6ana6_fader],
            self.mix6ana6_fader: ['/Mixer/fader', 5, 5, self.mix6ana5_fader],
            self.mix6ana7_fader: ['/Mixer/fader', 5, 6, self.mix6ana8_fader],
            self.mix6ana8_fader: ['/Mixer/fader', 5, 7, self.mix6ana7_fader],
            self.mix6aes1_fader: ['/Mixer/fader', 5, 8, self.mix6aes2_fader],
            self.mix6aes2_fader: ['/Mixer/fader', 5, 9, self.mix6aes1_fader],
            self.mix6spdif1_fader: ['/Mixer/fader', 5, 10, self.mix6spdif2_fader],
            self.mix6spdif2_fader: ['/Mixer/fader', 5, 11, self.mix6spdif1_fader],
            self.mix6adat1_fader: ['/Mixer/fader', 5, 12, self.mix6adat2_fader],
            self.mix6adat2_fader: ['/Mixer/fader', 5, 13, self.mix6adat1_fader],
            self.mix6adat3_fader: ['/Mixer/fader', 5, 14, self.mix6adat4_fader],
            self.mix6adat4_fader: ['/Mixer/fader', 5, 15, self.mix6adat3_fader],
            self.mix6adat5_fader: ['/Mixer/fader', 5, 16, self.mix6adat6_fader],
            self.mix6adat6_fader: ['/Mixer/fader', 5, 17, self.mix6adat5_fader],
            self.mix6adat7_fader: ['/Mixer/fader', 5, 18, self.mix6adat8_fader],
            self.mix6adat8_fader: ['/Mixer/fader', 5, 19, self.mix6adat7_fader],
            
            self.mix7ana1_fader: ['/Mixer/fader', 6, 0, self.mix7ana2_fader],
            self.mix7ana2_fader: ['/Mixer/fader', 6, 1, self.mix7ana1_fader],
            self.mix7ana3_fader: ['/Mixer/fader', 6, 2, self.mix7ana4_fader],
            self.mix7ana4_fader: ['/Mixer/fader', 6, 3, self.mix7ana3_fader],
            self.mix7ana5_fader: ['/Mixer/fader', 6, 4, self.mix7ana6_fader],
            self.mix7ana6_fader: ['/Mixer/fader', 6, 5, self.mix7ana5_fader],
            self.mix7ana7_fader: ['/Mixer/fader', 6, 6, self.mix7ana8_fader],
            self.mix7ana8_fader: ['/Mixer/fader', 6, 7, self.mix7ana7_fader],
            self.mix7aes1_fader: ['/Mixer/fader', 6, 8, self.mix7aes2_fader],
            self.mix7aes2_fader: ['/Mixer/fader', 6, 9, self.mix7aes1_fader],
            self.mix7spdif1_fader: ['/Mixer/fader', 6, 10, self.mix7spdif2_fader],
            self.mix7spdif2_fader: ['/Mixer/fader', 6, 11, self.mix7spdif1_fader],
            self.mix7adat1_fader: ['/Mixer/fader', 6, 12, self.mix7adat2_fader],
            self.mix7adat2_fader: ['/Mixer/fader', 6, 13, self.mix7adat1_fader],
            self.mix7adat3_fader: ['/Mixer/fader', 6, 14, self.mix7adat4_fader],
            self.mix7adat4_fader: ['/Mixer/fader', 6, 15, self.mix7adat3_fader],
            self.mix7adat5_fader: ['/Mixer/fader', 6, 16, self.mix7adat6_fader],
            self.mix7adat6_fader: ['/Mixer/fader', 6, 17, self.mix7adat5_fader],
            self.mix7adat7_fader: ['/Mixer/fader', 6, 18, self.mix7adat8_fader],
            self.mix7adat8_fader: ['/Mixer/fader', 6, 19, self.mix7adat7_fader],
            
            self.mix8ana1_fader: ['/Mixer/fader', 7, 0, self.mix8ana2_fader],
            self.mix8ana2_fader: ['/Mixer/fader', 7, 1, self.mix8ana1_fader],
            self.mix8ana3_fader: ['/Mixer/fader', 7, 2, self.mix8ana4_fader],
            self.mix8ana4_fader: ['/Mixer/fader', 7, 3, self.mix8ana3_fader],
            self.mix8ana5_fader: ['/Mixer/fader', 7, 4, self.mix8ana6_fader],
            self.mix8ana6_fader: ['/Mixer/fader', 7, 5, self.mix8ana5_fader],
            self.mix8ana7_fader: ['/Mixer/fader', 7, 6, self.mix8ana8_fader],
            self.mix8ana8_fader: ['/Mixer/fader', 7, 7, self.mix8ana7_fader],
            self.mix8aes1_fader: ['/Mixer/fader', 7, 8, self.mix8aes2_fader],
            self.mix8aes2_fader: ['/Mixer/fader', 7, 9, self.mix8aes1_fader],
            self.mix8spdif1_fader: ['/Mixer/fader', 7, 10, self.mix8spdif2_fader],
            self.mix8spdif2_fader: ['/Mixer/fader', 7, 11, self.mix8spdif1_fader],
            self.mix8adat1_fader: ['/Mixer/fader', 7, 12, self.mix8adat2_fader],
            self.mix8adat2_fader: ['/Mixer/fader', 7, 13, self.mix8adat1_fader],
            self.mix8adat3_fader: ['/Mixer/fader', 7, 14, self.mix8adat4_fader],
            self.mix8adat4_fader: ['/Mixer/fader', 7, 15, self.mix8adat3_fader],
            self.mix8adat5_fader: ['/Mixer/fader', 7, 16, self.mix8adat6_fader],
            self.mix8adat6_fader: ['/Mixer/fader', 7, 17, self.mix8adat5_fader],
            self.mix8adat7_fader: ['/Mixer/fader', 7, 18, self.mix8adat8_fader],
            self.mix8adat8_fader: ['/Mixer/fader', 7, 19, self.mix8adat7_fader],
        }
        ...
        self.ChannelControls={
            ...
            self.mix5ana1_pan:   ['/Mixer/pan', 4, 0],
            self.mix5ana2_pan:   ['/Mixer/pan', 4, 1],
            self.mix5ana3_pan:   ['/Mixer/pan', 4, 2],
            self.mix5ana4_pan:   ['/Mixer/pan', 4, 3],
            self.mix5ana5_pan:   ['/Mixer/pan', 4, 4],
            self.mix5ana6_pan:   ['/Mixer/pan', 4, 5],
            self.mix5ana7_pan:   ['/Mixer/pan', 4, 6],
            self.mix5ana8_pan:   ['/Mixer/pan', 4, 7],
            self.mix5aes1_pan:   ['/Mixer/pan', 4, 8],
            self.mix5aes2_pan:   ['/Mixer/pan', 4, 9],
            self.mix5spdif1_pan: ['/Mixer/pan', 4, 10],
            self.mix5spdif2_pan: ['/Mixer/pan', 4, 11],
            self.mix5adat1_pan:  ['/Mixer/pan', 4, 12],
            self.mix5adat2_pan:  ['/Mixer/pan', 4, 13],
            self.mix5adat3_pan:  ['/Mixer/pan', 4, 14],
            self.mix5adat4_pan:  ['/Mixer/pan', 4, 15],
            self.mix5adat5_pan:  ['/Mixer/pan', 4, 16],
            self.mix5adat6_pan:  ['/Mixer/pan', 4, 17],
            self.mix5adat7_pan:  ['/Mixer/pan', 4, 18],
            self.mix5adat8_pan:  ['/Mixer/pan', 4, 19],
            
            self.mix6ana1_pan:   ['/Mixer/pan', 5, 0],
            self.mix6ana2_pan:   ['/Mixer/pan', 5, 1],
            self.mix6ana3_pan:   ['/Mixer/pan', 5, 2],
            self.mix6ana4_pan:   ['/Mixer/pan', 5, 3],
            self.mix6ana5_pan:   ['/Mixer/pan', 5, 4],
            self.mix6ana6_pan:   ['/Mixer/pan', 5, 5],
            self.mix6ana7_pan:   ['/Mixer/pan', 5, 6],
            self.mix6ana8_pan:   ['/Mixer/pan', 5, 7],
            self.mix6aes1_pan:   ['/Mixer/pan', 5, 8],
            self.mix6aes2_pan:   ['/Mixer/pan', 5, 9],
            self.mix6spdif1_pan: ['/Mixer/pan', 5, 10],
            self.mix6spdif2_pan: ['/Mixer/pan', 5, 11],
            self.mix6adat1_pan:  ['/Mixer/pan', 5, 12],
            self.mix6adat2_pan:  ['/Mixer/pan', 5, 13],
            self.mix6adat3_pan:  ['/Mixer/pan', 5, 14],
            self.mix6adat4_pan:  ['/Mixer/pan', 5, 15],
            self.mix6adat5_pan:  ['/Mixer/pan', 5, 16],
            self.mix6adat6_pan:  ['/Mixer/pan', 5, 17],
            self.mix6adat7_pan:  ['/Mixer/pan', 5, 18],
            self.mix6adat8_pan:  ['/Mixer/pan', 5, 19],
            
            self.mix7ana1_pan:   ['/Mixer/pan', 6, 0],
            self.mix7ana2_pan:   ['/Mixer/pan', 6, 1],
            self.mix7ana3_pan:   ['/Mixer/pan', 6, 2],
            self.mix7ana4_pan:   ['/Mixer/pan', 6, 3],
            self.mix7ana5_pan:   ['/Mixer/pan', 6, 4],
            self.mix7ana6_pan:   ['/Mixer/pan', 6, 5],
            self.mix7ana7_pan:   ['/Mixer/pan', 6, 6],
            self.mix7ana8_pan:   ['/Mixer/pan', 6, 7],
            self.mix7aes1_pan:   ['/Mixer/pan', 6, 8],
            self.mix7aes2_pan:   ['/Mixer/pan', 6, 9],
            self.mix7spdif1_pan: ['/Mixer/pan', 6, 10],
            self.mix7spdif2_pan: ['/Mixer/pan', 6, 11],
            self.mix7adat1_pan:  ['/Mixer/pan', 6, 12],
            self.mix7adat2_pan:  ['/Mixer/pan', 6, 13],
            self.mix7adat3_pan:  ['/Mixer/pan', 6, 14],
            self.mix7adat4_pan:  ['/Mixer/pan', 6, 15],
            self.mix7adat5_pan:  ['/Mixer/pan', 6, 16],
            self.mix7adat6_pan:  ['/Mixer/pan', 6, 17],
            self.mix7adat7_pan:  ['/Mixer/pan', 6, 18],
            self.mix7adat8_pan:  ['/Mixer/pan', 6, 19],
            
            self.mix8ana1_pan:   ['/Mixer/pan', 7, 0],
            self.mix8ana2_pan:   ['/Mixer/pan', 7, 1],
            self.mix8ana3_pan:   ['/Mixer/pan', 7, 2],
            self.mix8ana4_pan:   ['/Mixer/pan', 7, 3],
            self.mix8ana5_pan:   ['/Mixer/pan', 7, 4],
            self.mix8ana6_pan:   ['/Mixer/pan', 7, 5],
            self.mix8ana7_pan:   ['/Mixer/pan', 7, 6],
            self.mix8ana8_pan:   ['/Mixer/pan', 7, 7],
            self.mix8aes1_pan:   ['/Mixer/pan', 7, 8],
            self.mix8aes2_pan:   ['/Mixer/pan', 7, 9],
            self.mix8spdif1_pan: ['/Mixer/pan', 7, 10],
            self.mix8spdif2_pan: ['/Mixer/pan', 7, 11],
            self.mix8adat1_pan:  ['/Mixer/pan', 7, 12],
            self.mix8adat2_pan:  ['/Mixer/pan', 7, 13],
            self.mix8adat3_pan:  ['/Mixer/pan', 7, 14],
            self.mix8adat4_pan:  ['/Mixer/pan', 7, 15],
            self.mix8adat5_pan:  ['/Mixer/pan', 7, 16],
            self.mix8adat6_pan:  ['/Mixer/pan', 7, 17],
            self.mix8adat7_pan:  ['/Mixer/pan', 7, 18],
            self.mix8adat8_pan:  ['/Mixer/pan', 7, 19],
        }
        ...
        self.ChannelBinarySwitches={
            ...
            self.mix5ana1_mute:  ['/Mixer/mute', 4, 0],
            self.mix5ana2_mute:  ['/Mixer/mute', 4, 1],
            self.mix5ana3_mute:  ['/Mixer/mute', 4, 2],
            self.mix5ana4_mute:  ['/Mixer/mute', 4, 3],
            self.mix5ana5_mute:  ['/Mixer/mute', 4, 4],
            self.mix5ana6_mute:  ['/Mixer/mute', 4, 5],
            self.mix5ana7_mute:  ['/Mixer/mute', 4, 6],
            self.mix5ana8_mute:  ['/Mixer/mute', 4, 7],
            self.mix5aes1_mute:  ['/Mixer/mute', 4, 8],
            self.mix5aes2_mute:  ['/Mixer/mute', 4, 9],
            self.mix5spdif1_mute: ['/Mixer/mute', 4, 10],
            self.mix5spdif2_mute: ['/Mixer/mute', 4, 11],
            self.mix5adat1_mute: ['/Mixer/mute', 4, 12],
            self.mix5adat2_mute: ['/Mixer/mute', 4, 13],
            self.mix5adat3_mute: ['/Mixer/mute', 4, 14],
            self.mix5adat4_mute: ['/Mixer/mute', 4, 15],
            self.mix5adat5_mute: ['/Mixer/mute', 4, 16],
            self.mix5adat6_mute: ['/Mixer/mute', 4, 17],
            self.mix5adat7_mute: ['/Mixer/mute', 4, 18],
            self.mix5adat8_mute: ['/Mixer/mute', 4, 19],
            self.mix5ana1_solo:  ['/Mixer/solo', 4, 0],
            self.mix5ana2_solo:  ['/Mixer/solo', 4, 1],
            self.mix5ana3_solo:  ['/Mixer/solo', 4, 2],
            self.mix5ana4_solo:  ['/Mixer/solo', 4, 3],
            self.mix5ana5_solo:  ['/Mixer/solo', 4, 4],
            self.mix5ana6_solo:  ['/Mixer/solo', 4, 5],
            self.mix5ana7_solo:  ['/Mixer/solo', 4, 6],
            self.mix5ana8_solo:  ['/Mixer/solo', 4, 7],
            self.mix5aes1_solo:  ['/Mixer/solo', 4, 8],
            self.mix5aes2_solo:  ['/Mixer/solo', 4, 9],
            self.mix5spdif1_solo: ['/Mixer/solo', 4, 10],
            self.mix5spdif2_solo: ['/Mixer/solo', 4, 11],
            self.mix5adat1_solo: ['/Mixer/solo', 4, 12],
            self.mix5adat2_solo: ['/Mixer/solo', 4, 13],
            self.mix5adat3_solo: ['/Mixer/solo', 4, 14],
            self.mix5adat4_solo: ['/Mixer/solo', 4, 15],
            self.mix5adat5_solo: ['/Mixer/solo', 4, 16],
            self.mix5adat6_solo: ['/Mixer/solo', 4, 17],
            self.mix5adat7_solo: ['/Mixer/solo', 4, 18],
            self.mix5adat8_solo: ['/Mixer/solo', 4, 19],
            
            self.mix6ana1_mute:  ['/Mixer/mute', 5, 0],
            self.mix6ana2_mute:  ['/Mixer/mute', 5, 1],
            self.mix6ana3_mute:  ['/Mixer/mute', 5, 2],
            self.mix6ana4_mute:  ['/Mixer/mute', 5, 3],
            self.mix6ana5_mute:  ['/Mixer/mute', 5, 4],
            self.mix6ana6_mute:  ['/Mixer/mute', 5, 5],
            self.mix6ana7_mute:  ['/Mixer/mute', 5, 6],
            self.mix6ana8_mute:  ['/Mixer/mute', 5, 7],
            self.mix6aes1_mute:  ['/Mixer/mute', 5, 8],
            self.mix6aes2_mute:  ['/Mixer/mute', 5, 9],
            self.mix6spdif1_mute: ['/Mixer/mute', 5, 10],
            self.mix6spdif2_mute: ['/Mixer/mute', 5, 11],
            self.mix6adat1_mute: ['/Mixer/mute', 5, 12],
            self.mix6adat2_mute: ['/Mixer/mute', 5, 13],
            self.mix6adat3_mute: ['/Mixer/mute', 5, 14],
            self.mix6adat4_mute: ['/Mixer/mute', 5, 15],
            self.mix6adat5_mute: ['/Mixer/mute', 5, 16],
            self.mix6adat6_mute: ['/Mixer/mute', 5, 17],
            self.mix6adat7_mute: ['/Mixer/mute', 5, 18],
            self.mix6adat8_mute: ['/Mixer/mute', 5, 19],
            self.mix6ana1_solo:  ['/Mixer/solo', 5, 0],
            self.mix6ana2_solo:  ['/Mixer/solo', 5, 1],
            self.mix6ana3_solo:  ['/Mixer/solo', 5, 2],
            self.mix6ana4_solo:  ['/Mixer/solo', 5, 3],
            self.mix6ana5_solo:  ['/Mixer/solo', 5, 4],
            self.mix6ana6_solo:  ['/Mixer/solo', 5, 5],
            self.mix6ana7_solo:  ['/Mixer/solo', 5, 6],
            self.mix6ana8_solo:  ['/Mixer/solo', 5, 7],
            self.mix6aes1_solo:  ['/Mixer/solo', 5, 8],
            self.mix6aes2_solo:  ['/Mixer/solo', 5, 9],
            self.mix6spdif1_solo: ['/Mixer/solo', 5, 10],
            self.mix6spdif2_solo: ['/Mixer/solo', 5, 11],
            self.mix6adat1_solo: ['/Mixer/solo', 5, 12],
            self.mix6adat2_solo: ['/Mixer/solo', 5, 13],
            self.mix6adat3_solo: ['/Mixer/solo', 5, 14],
            self.mix6adat4_solo: ['/Mixer/solo', 5, 15],
            self.mix6adat5_solo: ['/Mixer/solo', 5, 16],
            self.mix6adat6_solo: ['/Mixer/solo', 5, 17],
            self.mix6adat7_solo: ['/Mixer/solo', 5, 18],
            self.mix6adat8_solo: ['/Mixer/solo', 5, 19],
            
            self.mix7ana1_mute:  ['/Mixer/mute', 6, 0],
            self.mix7ana2_mute:  ['/Mixer/mute', 6, 1],
            self.mix7ana3_mute:  ['/Mixer/mute', 6, 2],
            self.mix7ana4_mute:  ['/Mixer/mute', 6, 3],
            self.mix7ana5_mute:  ['/Mixer/mute', 6, 4],
            self.mix7ana6_mute:  ['/Mixer/mute', 6, 5],
            self.mix7ana7_mute:  ['/Mixer/mute', 6, 6],
            self.mix7ana8_mute:  ['/Mixer/mute', 6, 7],
            self.mix7aes1_mute:  ['/Mixer/mute', 6, 8],
            self.mix7aes2_mute:  ['/Mixer/mute', 6, 9],
            self.mix7spdif1_mute: ['/Mixer/mute', 6, 10],
            self.mix7spdif2_mute: ['/Mixer/mute', 6, 11],
            self.mix7adat1_mute: ['/Mixer/mute', 6, 12],
            self.mix7adat2_mute: ['/Mixer/mute', 6, 13],
            self.mix7adat3_mute: ['/Mixer/mute', 6, 14],
            self.mix7adat4_mute: ['/Mixer/mute', 6, 15],
            self.mix7adat5_mute: ['/Mixer/mute', 6, 16],
            self.mix7adat6_mute: ['/Mixer/mute', 6, 17],
            self.mix7adat7_mute: ['/Mixer/mute', 6, 18],
            self.mix7adat8_mute: ['/Mixer/mute', 6, 19],
            self.mix7ana1_solo:  ['/Mixer/solo', 6, 0],
            self.mix7ana2_solo:  ['/Mixer/solo', 6, 1],
            self.mix7ana3_solo:  ['/Mixer/solo', 6, 2],
            self.mix7ana4_solo:  ['/Mixer/solo', 6, 3],
            self.mix7ana5_solo:  ['/Mixer/solo', 6, 4],
            self.mix7ana6_solo:  ['/Mixer/solo', 6, 5],
            self.mix7ana7_solo:  ['/Mixer/solo', 6, 6],
            self.mix7ana8_solo:  ['/Mixer/solo', 6, 7],
            self.mix7aes1_solo:  ['/Mixer/solo', 6, 8],
            self.mix7aes2_solo:  ['/Mixer/solo', 6, 9],
            self.mix7spdif1_solo: ['/Mixer/solo', 6, 10],
            self.mix7spdif2_solo: ['/Mixer/solo', 6, 11],
            self.mix7adat1_solo: ['/Mixer/solo', 6, 12],
            self.mix7adat2_solo: ['/Mixer/solo', 6, 13],
            self.mix7adat3_solo: ['/Mixer/solo', 6, 14],
            self.mix7adat4_solo: ['/Mixer/solo', 6, 15],
            self.mix7adat5_solo: ['/Mixer/solo', 6, 16],
            self.mix7adat6_solo: ['/Mixer/solo', 6, 17],
            self.mix7adat7_solo: ['/Mixer/solo', 6, 18],
            self.mix7adat8_solo: ['/Mixer/solo', 6, 19],
            
            self.mix8ana1_mute:  ['/Mixer/mute', 7, 0],
            self.mix8ana2_mute:  ['/Mixer/mute', 7, 1],
            self.mix8ana3_mute:  ['/Mixer/mute', 7, 2],
            self.mix8ana4_mute:  ['/Mixer/mute', 7, 3],
            self.mix8ana5_mute:  ['/Mixer/mute', 7, 4],
            self.mix8ana6_mute:  ['/Mixer/mute', 7, 5],
            self.mix8ana7_mute:  ['/Mixer/mute', 7, 6],
            self.mix8ana8_mute:  ['/Mixer/mute', 7, 7],
            self.mix8aes1_mute:  ['/Mixer/mute', 7, 8],
            self.mix8aes2_mute:  ['/Mixer/mute', 7, 9],
            self.mix8spdif1_mute: ['/Mixer/mute', 7, 10],
            self.mix8spdif2_mute: ['/Mixer/mute', 7, 11],
            self.mix8adat1_mute: ['/Mixer/mute', 7, 12],
            self.mix8adat2_mute: ['/Mixer/mute', 7, 13],
            self.mix8adat3_mute: ['/Mixer/mute', 7, 14],
            self.mix8adat4_mute: ['/Mixer/mute', 7, 15],
            self.mix8adat5_mute: ['/Mixer/mute', 7, 16],
            self.mix8adat6_mute: ['/Mixer/mute', 7, 17],
            self.mix8adat7_mute: ['/Mixer/mute', 7, 18],
            self.mix8adat8_mute: ['/Mixer/mute', 7, 19],
            self.mix8ana1_solo:  ['/Mixer/solo', 7, 0],
            self.mix8ana2_solo:  ['/Mixer/solo', 7, 1],
            self.mix8ana3_solo:  ['/Mixer/solo', 7, 2],
            self.mix8ana4_solo:  ['/Mixer/solo', 7, 3],
            self.mix8ana5_solo:  ['/Mixer/solo', 7, 4],
            self.mix8ana6_solo:  ['/Mixer/solo', 7, 5],
            self.mix8ana7_solo:  ['/Mixer/solo', 7, 6],
            self.mix8ana8_solo:  ['/Mixer/solo', 7, 7],
            self.mix8aes1_solo:  ['/Mixer/solo', 7, 8],
            self.mix8aes2_solo:  ['/Mixer/solo', 7, 9],
            self.mix8spdif1_solo: ['/Mixer/solo', 7, 10],
            self.mix8spdif2_solo: ['/Mixer/solo', 7, 11],
            self.mix8adat1_solo: ['/Mixer/solo', 7, 12],
            self.mix8adat2_solo: ['/Mixer/solo', 7, 13],
            self.mix8adat3_solo: ['/Mixer/solo', 7, 14],
            self.mix8adat4_solo: ['/Mixer/solo', 7, 15],
            self.mix8adat5_solo: ['/Mixer/solo', 7, 16],
            self.mix8adat6_solo: ['/Mixer/solo', 7, 17],
            self.mix8adat7_solo: ['/Mixer/solo', 7, 18],
            self.mix8adat8_solo: ['/Mixer/solo', 7, 19],
        }
    ...
    def updateFader(self, a0):
        ...
        self.hw.setContignuous(self.Faders[sender][0], vol)
    ...
    def initValues_g3(self):
        ...
        # So long as the MixerChannels_828Mk23 definition in
